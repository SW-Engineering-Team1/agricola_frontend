...
export default{
    data(){
        return {
            card:[
                {id: '0',title: 'Smaller farmer'},
                {id: '1',title: 'Walled workman'},
                {id: '2',title: 'Roof mower'},
                {id: '3',title: 'Adoptive parents'},
                {id: '4',title: 'Woodcutter'},
                {id: '5',title: 'Merchandiser'},
                {id: '6',title: 'Organic farmer'},
            ],
